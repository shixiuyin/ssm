				...
				<div class="row">
					<form class="form-horizontal"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputEmail3"
									placeholder="empno" name="empno" value="${empInfo.empno}"
									readonly="readonly">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputPassword3"
									placeholder="例如:保镖" name="job" value="${empInfo.job }">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputPassword3"
									placeholder="例如:1" name="mgr" value="${empInfo.mgr }">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputPassword3"
									placeholder="例如:2000.00" name="sal" value="${empInfo.sal }">
							</div>
						</div>
							...
							<div class="col-sm-10">
								<select class="form-control" name="deptno">
									<c:forEach items="${deptList}" var="dept">
										<!-- 设置默认选中 -->
										<c:if test="${dept.deptno ==empInfo.deptno}">
